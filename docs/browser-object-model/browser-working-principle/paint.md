...
![](/browser-working-principle/style-layout-and-paint-order.png)
...
![](/browser-working-principle/animation-frame-on-timeline.avif)

即使渲染操作能跟上屏幕刷新，这些计算也会在主线程上运行，这意味着当你的应用程序运行 JavaScript 时动画可能会被阻塞。

![](/browser-working-principle/javascript-blocking.avif)
...
![](/browser-working-principle/small-javascript-block.avif)
