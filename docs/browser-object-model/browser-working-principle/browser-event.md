...
![](/browser-working-principle/input-event-from-browser-to-renderer.avif)
...
![](/browser-working-principle/non-fast-scrollable-region.avif)
...
![](/browser-working-principle/horizontally-scrollable-website.avif)
...
![](/browser-working-principle/main-process-check-paint-record.avif)
...
![](/browser-working-principle/massive-event-and-website-flicker.avif)
...
![](/browser-working-principle/same-timeline-composite-event.avif)
...
![](/browser-working-principle/touch-gesture-and-coalesced-event.avif)
