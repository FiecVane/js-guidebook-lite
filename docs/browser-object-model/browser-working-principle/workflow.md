...
![](/browser-working-principle/renderer-process-with-main-thread.avif)
...
![](/browser-working-principle/browser-working-process.avif)
...
![](/browser-working-principle/webkit-workflow.webp)

### Gecko 实现

![](/browser-working-principle/gecko-workflow.avif)
