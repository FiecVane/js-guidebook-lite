...
![渲染树构建](/browser-working-principle/render-tree.png)
...
![渲染树及对应DOM树](/browser-working-principle/render-tree-and-dom-tree.avif)
...
![主线程解析CSS以添加计算后样式](/browser-working-principle/main-process-parsing-css-and-computed-style.avif)
