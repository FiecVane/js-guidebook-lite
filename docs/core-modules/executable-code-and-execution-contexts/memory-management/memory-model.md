...
![](/memory-model/table-tennis-example.avif)
...
![](/memory-model/queue-structure.avif)
...
![](/memory-model/sample-illustruction.avif)
...
![](/memory-model/basic-type-copy-sample.avif)
...
![](/memory-model/refered-type-copy-sample.avif)
